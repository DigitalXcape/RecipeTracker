...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 325756069163674066, ; hash 0x485516b41eda9d2, from name: RecipeBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 10
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2809420148232800763, ; hash 0x26fd10bd683dc9fb, from name: RecipeBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		i64 9188529507882746216, ; hash 0x7f8436e78d8bc168, from name: libaot-RecipeBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 240
	...
	%struct.DSOCacheEntry {
		i64 9870293090338557048, ; hash 0x88fa5345469f4c78, from name: aot-RecipeBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 255
	...
	%struct.DSOCacheEntry {
		i64 10113092171039017921, ; hash 0x8c58ebbf83908bc1, from name: aot-RecipeBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 10544567969498586429, ; hash 0x9255d4b363ecdd3d, from name: libaot-RecipeBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6579433c-b8c3-4e7c-8f5b-f2436bccb98f\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.recipebook\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-RecipeBook.dll.so\00", align 16
