...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2190761425, ; hash 0x82945dd1, from name: aot-RecipeBook.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2652090864, ; hash 0x9e13b1f0, from name: RecipeBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 301
	...
	%struct.DSOCacheEntry {
		i64 2955734599, ; hash 0xb02cee47, from name: aot-RecipeBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 3776679536, ; hash 0xe11b8e70, from name: RecipeBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 3898649545, ; hash 0xe860abc9, from name: libaot-RecipeBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
	...
	%struct.DSOCacheEntry {
		i64 4010669160, ; hash 0xef0df468, from name: libaot-RecipeBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RecipeBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 461
